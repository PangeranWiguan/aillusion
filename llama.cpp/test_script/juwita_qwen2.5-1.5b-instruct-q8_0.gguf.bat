...
set "system_prompt="
for /f "usebackq delims=" %%i in ("juwita_system_prompt.txt") do set "system_prompt=!system_prompt! %%i"
...
echo %full_prompt%
llama-cli.exe -m models/qwen2.5-1.5b-instruct-q8_0.gguf -sys PROMPT -p "%full_prompt%" --temp 0.7 --top-p 0.9
