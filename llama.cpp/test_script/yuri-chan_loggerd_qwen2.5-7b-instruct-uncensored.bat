...
set "system_prompt="
for /f "usebackq delims=" %%i in ("test_script/yuri-chan_system_prompt.txt") do set "system_prompt=!system_prompt! %%i"
...
echo %full_prompt%
llama-cli.exe -m models/Qwen2.5-7B-Instruct-Uncensored.Q8_0.gguf -sys "%full_prompt%" -p "Hi" --temp 2.0 --top-p 0.9 -co --keep -1 --log-file chat_log.txt --log-prefix --log-timestamps -c 32768 -s 515252267
