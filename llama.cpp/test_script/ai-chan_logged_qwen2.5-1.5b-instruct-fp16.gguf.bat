...
echo %full_prompt%
llama-cli.exe -m models/qwen2.5-1.5b-instruct-fp16.gguf -sys "%full_prompt%" -p "Hi" --temp 2.0 --top-p 0.9 -t 12 -co --keep -1 --log-file chat_log.txt --log-prefix --log-timestamps -c 100000 -s 1288850135
